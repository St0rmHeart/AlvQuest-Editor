namespace AlvQuest_Editor
{
    public class Arena
    {
        ...
        //
        private readonly TurnSwitch _isTurnEnd = new TurnSwitch();
        //
        private readonly DamageModule _damageModule = new DamageModule();
        ...
        public Arena(Character player, Character enemy)
        {
            ...
            for (int i = 0; i < initArray.Length; i++)
            {
                ...
                {
                    foreach (BaseEffect effect in item.Effects)
                    {
